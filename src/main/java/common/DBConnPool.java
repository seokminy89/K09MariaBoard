...
/*
JNDI(Java Namaing and Directory Interface)
...
public class DBConnPool {
	...
	public DBConnPool() {
		try {
			...
			여기서 얻어오는 톰캣의 루트 디렉토리명은 java:comp/env로 이미
	...
	//사용이 끝난 객체를 Pool에 반납한다. 즉 여기서의 close는 객체의 소멸이 아니다.
	public void close() {
		try {
			if(rs != null) rs.close();
