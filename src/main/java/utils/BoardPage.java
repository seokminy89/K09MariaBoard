...
public class BoardPage {
	...
	*/
	...
	//매개변수 (순서대로 전체게시물 갯수, 한페이지출력갯수, 한블럭당출력페이지수, 현재페이지번호, 현재페이지명)
	public static String pagingStr(int totalCount, int pageSize, int blockPage,
		...
		//이전 블럭으로 바로 가기 링크(첫번째 블럭에서는 숨김처리)
		if(pageTemp != 1) {
		...
		//각 페이지로 바로가기 링크(blockPage 수만큼 출력됨)
		int blockCount = 1;
	...
	해결하기 위해 메서드를 추가한다.
	검색 파라미터 정보를 저장하고 있는 Map컬렉션을 매개변수로 추가한다.
	*/
	public static String pagingStr(int totalCount, int pageSize, int blockPage,
